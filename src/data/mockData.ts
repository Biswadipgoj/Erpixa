// Mock data for all Buis AI modules

// ── Auth ──────────────────────────────────────────────────────
export const currentUser = {
  id: '1',
  name: 'Alex Johnson',
  email: 'alex@buisai.com',
  role: 'Administrator',
  avatar: '',
  initials: 'AJ',
  company: 'Buis AI Corp',
};

// ── CRM ──────────────────────────────────────────────────────
export const crmStages = [
  { id: 's1', name: 'New',         probability: 10, color: '#6B7280', count: 4 },
  { id: 's2', name: 'Qualified',   probability: 30, color: '#3B82F6', count: 6 },
  { id: 's3', name: 'Proposition', probability: 60, color: '#F59E0B', count: 3 },
  { id: 's4', name: 'Won',         probability: 100, color: '#22C55E', count: 2 },
];
...
export const employees = [
  { id: 'e1', name: 'Alex Johnson',   role: 'CTO',              dept: 'Engineering', email: 'alex@buisai.com',  phone: '+1 555-0101', status: 'Active', joinDate: '2022-03-01', initials: 'AJ', color: '#4F46E5' },
  { id: 'e2', name: 'Sara Miles',     role: 'Head of Sales',    dept: 'Sales',       email: 'sara@buisai.com',  phone: '+1 555-0102', status: 'Active', joinDate: '2022-06-15', initials: 'SM', color: '#0EA5E9' },
  { id: 'e3', name: 'Paul Kim',       role: 'Senior Dev',       dept: 'Engineering', email: 'paul@buisai.com',  phone: '+1 555-0103', status: 'Active', joinDate: '2023-01-10', initials: 'PK', color: '#22C55E' },
  { id: 'e4', name: 'Maria Garcia',   role: 'HR Manager',       dept: 'HR',          email: 'maria@buisai.com', phone: '+1 555-0104', status: 'Active', joinDate: '2022-09-01', initials: 'MG', color: '#F59E0B' },
  { id: 'e5', name: 'David Lee',      role: 'Finance Lead',     dept: 'Finance',     email: 'david@buisai.com', phone: '+1 555-0105', status: 'Active', joinDate: '2023-04-15', initials: 'DL', color: '#EF4444' },
  { id: 'e6', name: 'Emma Wilson',    role: 'Designer',         dept: 'Product',     email: 'emma@buisai.com',  phone: '+1 555-0106', status: 'Active', joinDate: '2023-07-01', initials: 'EW', color: '#8B5CF6' },
  { id: 'e7', name: 'James Brown',    role: 'Marketing Lead',   dept: 'Marketing',   email: 'james@buisai.com', phone: '+1 555-0107', status: 'On Leave', joinDate: '2022-11-15', initials: 'JB', color: '#EC4899' },
];

// ── PROJECTS ──────────────────────────────────────────────────
export const projects = [
  { id: 'proj1', name: 'Buis AI Platform v2', client: 'Internal', status: 'In Progress', progress: 72, dueDate: '2026-09-01', team: ['AJ','PK','EW'], tasks: 34, done: 24 },
